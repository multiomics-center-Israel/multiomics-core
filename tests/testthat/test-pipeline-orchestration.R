...
# =============================================================================
# Tests: pipe_multiomics() — removed
# =============================================================================
# Multi-omics integration layer was split into a separate review branch.
# These tests will be restored when pipe_multiomics() is merged back.

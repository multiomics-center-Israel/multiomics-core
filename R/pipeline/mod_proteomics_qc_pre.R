...
mod_proteomics_qc_pre <- function(pre, config, run_dir) {
  ...
  files <- c(files, f_pca12); plots$pca_1_2 <- p12
  ...
  files <- c(files, f_pca13); plots$pca_1_3 <- p13
  ...
  files <- c(files, f_hist); plots$density <- p_dens
  ...
  files <- c(files, written); plots$dist_heatmap <- ph
  ...
  files <- c(files, written_na); plots$dist_heatmap_na <- ph_na
  ...
  files <- c(files, f_hm_nocol); plots$heatmap_nocol <- p_hm_nocol

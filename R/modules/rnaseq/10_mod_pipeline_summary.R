#' Module wrapper: RNA-seq Pipeline Summary
#'
#' Generates a dark-themed HTML summary of the entire pipeline workflow,
#' including wet lab, upstream bioinformatics, and downstream analysis steps.
#' Uses Claude Code CLI for polished descriptions when commentary is enabled.
#'
